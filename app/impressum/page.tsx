...
export const metadata = buildMetadata({
  title: "Impressum",
  description: "Impressum gemaess den veroeffentlichten Angaben auf der Webseite.",
  path: "/impressum"
});
  ...
  return (
    <section className="section">
      <div className="container-page card -rotate-1" style={{ borderRadius: wobblyMd }}>
        ...
        <p className="mt-2 text-sm"><strong>Vertreten durch:</strong> Sabine Musterfrau, Erika Mustermann, Sandra Musterfrau</p>
        ...
        <p className="mt-2 text-sm"><strong>Registereintrag:</strong> Vereinsregister, Registergericht Amtsgericht Musterstadt, Registernummer HR 999999</p>
        <p className="mt-2 text-sm"><strong>Verantwortlich fuer den Inhalt nach § 55 Abs. 2 RStV:</strong> Sabine Musterfrau, Erika Mustermann, Sandra Musterfrau</p>
